...
COPY --from=ocaml-app-base /usr/bin/app/nidhoggr/nidhoggr.exe /home/app/nidhoggr
RUN set -x && \
    : "Update and upgrade default packagee" && \
    apk update && apk upgrade && \
    apk add gmp ffmpeg unzip && \
    : "Create a user to execute application" && \
    adduser -D app && \
    : "Change owner to app" && \
    chown app:app /home/app/nidhoggr

WORKDIR /home/app
USER app
ENTRYPOINT /home/app/nidhoggr
